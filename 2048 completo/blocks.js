...
function set_pawn_color(pawn_value)
{
	if (pawn_value == 2)
		...
		return ("#060204");
	else if (pawn_value == 16384)
		return ("#060204");
	else if (pawn_value == 32768)
		return ("#060204");
	else if (pawn_value == 65536)
		return ("#060204");
	else if (pawn_value == 131072)
		return ("#060204");
	else if (pawn_value == 262144)
		return ("#060204");
	else if (pawn_value == 524288)
		return ("#060204");
	else if (pawn_value == 1048576)
		return ("#060204");
	else if (pawn_value == 2097152)
		return ("#060204");
	else if (pawn_value == 4194304)
		return ("#060204");
	else if (pawn_value == 8388608)
		return ("#060204");
	else 
		return ("#c55");
}
